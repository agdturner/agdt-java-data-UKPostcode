 ...
 * @author geoagdt
 */
public abstract class ONSPD_AbstractRecord2 extends ONSPD_AbstractRecord {
    ...
    protected String oldpct;
        ...
        protected ONSPD_AbstractRecord2() {}
    ...
    public ONSPD_AbstractRecord2(ONSPD_Environment env) {
        super(env);
        genind = "";
        pafind = "";
        addrct = "";
